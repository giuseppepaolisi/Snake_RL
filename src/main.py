...
def main():
    ...
    #agent.load(f'models/snake_{agent.get_model()}_{episodes}.pkl')
    ...
    env = Snake_Env(size=5, render_mode='human')  # Instantiate environment directly again
    num_episodes = 10
    for episode in range(num_episodes):
        ...
        while True:
            action = dqn_agent.choose_action(state)  # Changed to dqn_agent
